...
mkdir /mnt/$2
echo "//$1.file.core.windows.net/$2 /mnt/$2 cifs vers=3.0,username=$1,password=$3,dir_mode=0777,file_mode=0777" >> /etc/fstab
mount -a
...
echo "* * * * * root cp /10.0.247.* /mnt/$2" >> /etc/crontab
